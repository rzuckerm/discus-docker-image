DISCUS_VERSION := $(shell cat DISCUS_VERSION)
DISCUS_DEPS := $(wildcard DISCUS_*)
DOCKER_TAG_PREFIX := rzuckerm/discus:$(DISCUS_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(DISCUS_DEPS)
